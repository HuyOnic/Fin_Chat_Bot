...
def get_organization_info(secCd, contentType, language, jwt_token):
    ...
    params = {
        "api": f"http://10.10.3.31:7000/market/api/public/organization-info?language={language}&secCd={secCd}&contentType={contentType}"
    }
    headers = {
...
if __name__=="__main__":
    secCd="VCB"
    language="VI"
    contentType="shareholdersStructureSection"
    ...
    pprint(get_organization_info(secCd, contentType, language, jwt_token))
