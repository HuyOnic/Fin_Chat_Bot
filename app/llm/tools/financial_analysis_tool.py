...
def get_financial_analysis(secCd, contentType, language, jwt_token):
    ...
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/financial-analysis?contentType={contentType}&duration=2&language={language}&secCd={secCd}'
        }
    headers = {
...
if __name__=="__main__":
    ...
    pprint(get_financial_analysis(secCd, contentType, language, jwt_token))
