...
def get_financial_infomation(secCd, contentType, language, jwt_token):
    ...
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/financial-information?duration=1&language={language}&secCd={secCd}&contentType={contentType}'
        }
    headers = {
