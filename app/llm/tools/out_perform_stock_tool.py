...
def get_outperform_stock(contentType, language, jwt_token):
    ...
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/outperform-stock?language={language}&contentType={contentType}'
    }
    headers = {
...
if __name__=="__main__":
    language="VI"
    contentType="TOP_STOCKS_WITH_SIGNIFICANT_CHANGES"
    ...
    print(get_outperform_stock(contentType, language, jwt_token))
