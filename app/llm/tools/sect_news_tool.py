...
import requests
# API bị lỗi, trả kết quả tào lao
def get_sect_news(secCd, language, jwt_token):
    url = "https://api-ai.goline.vn/api/public/chat-management/test"
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/sect-news?secCd={secCd}&language={language}&page=0&pageSize=3'
    }
    headers = {
...
if __name__=="__main__":
    ...
    print(get_sect_news(secCd, language, jwt_token))
