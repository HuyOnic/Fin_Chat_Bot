...
def get_display_account_info(contentType, language, jwt_token):
    url = "https://api-ai.goline.vn/api/public/chat-management/test"
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/displayAccountInfo?fromDate=USER_FROM_DATE \
                                                                            &toDate=USER_TO_DATE \
                                                                            &cusNo=USER_CUST_NO \
...
if __name__=="__main__":
    ...
    pprint(get_display_account_info(contentType, language, jwt_token))
