...
def get_top_sec_index(contentType, language, jwt_token):
    url = "https://api-ai.goline.vn/api/public/chat-management/test"
    params = {
        "api": f"http://10.10.3.31:7000/market/api/public/top-sec-index?top=5&language={language}&contentType={contentType}"
    }
    headers = {
...
if __name__=="__main__":
    ...
    pprint(get_top_sec_index(contentType, language, jwt_token))
