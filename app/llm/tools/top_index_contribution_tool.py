...
def get_top_index_contribution(secCd, contentType, language, jwt_token):
    ...
    params = {
        "api": f"http://10.10.3.31:7000/market/api/public/top-index-contribution?marketCdList={secCd}&language={language}&contentType={contentType}"
    }
    headers = {
...
if __name__=="__main__":
    ...
    pprint(get_top_index_contribution(secCd, contentType, language, jwt_token))
