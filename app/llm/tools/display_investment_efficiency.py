...
def get_display_investment_efficiency(contentType, language, jwt_token):
    url = "https://api-ai.goline.vn/api/public/chat-management/test"
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/displayInvestmentEfficiency?fromDate=USER_FROM_DATE \
                                                                            &toDate=USER_TO_DATE \
                                                                            &cusNo=USER_CUST_NO \
    ...
    headers = {
        ...
        "Cookie": f'token_chatbot={jwt_token}'
    }
    json_body = {
        "token": jwt_token
    }
