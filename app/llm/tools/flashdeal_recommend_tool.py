...
def get_flashdeal_recommend(marketCdList, contentType, language, jwt_token):
    url = "https://api-ai.goline.vn/api/public/chat-management/test"
    params = {
        "api": f'http://10.10.3.31:7000/market/api/public/flashdeal-recommend?language={language}\
                                                                            &page=0\
                                                                            &pageSize=10\
                                                                            &marketCdList={marketCdList}\
...
if __name__=="__main__":
    ...
    pprint(get_flashdeal_recommend(secCd, contentType, language, jwt_token))
